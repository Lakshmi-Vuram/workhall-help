...
<Container>
<Row className="justify-content-center position-relative bottom-5">
...
<Row className="mt-4">
    <Col md="6">
        <Nav defaultActiveKey="/index" className="flex-column">
            <Nav.Link href="/"> What's the difference between Free Forever and Unlimited?</Nav.Link>
            <Nav.Link href="/"> How can I Invite more people?</Nav.Link>
            <Nav.Link href="/"> What makes Workhall different?</Nav.Link>
            <Nav.Link href="/"> How can I request new features?</Nav.Link>
    ...
    <Col md="6">
        <Nav defaultActiveKey="/">
            <Nav.Link href="/"> What's the difference between Free Forever and Unlimited?</Nav.Link>
            <Nav.Link href="/"> How do I choose between custom or simple statuses?</Nav.Link>
            <Nav.Link href="/">Is there a discount for non-profit or educational companies?</Nav.Link>
            <Nav.Link href="/"> How do I change plans?</Nav.Link>
